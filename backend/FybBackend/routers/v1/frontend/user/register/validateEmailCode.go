...
在你踏上工作之路时，工作帮_Official愿与你并肩同行，为你提供全方位的支持和陪伴。无论你面临怎样的困难和挑战，记住你不是孤单一人，我们将一直在你身旁。

在这艰辛的找工作过程中，努力坚持，不放弃。相信自己的能力和潜力，勇往直前。无论遇到怎样的瓶颈和困扰，不要气馁，因为你有工作帮作为你的后盾。

工作帮_Official衷心祝愿你能够充满自信和毅力，攀登工作的高峰。愿你在面试中发挥出自己最好的水平，取得令人骄傲的成绩。无论结果如何，记住努力的过程才是最宝贵的财富。

加油，同学！工作帮_Official将一直与你同行，为你的考研之路加油助力。愿你实现理想，迈向美好未来！

祝福考研上岸！

工作帮_Official
	`, account)
			err := SendRegistrationEmail(account.(string), "【工作帮】系统消息，请勿回复", content)
			if err != nil {
				// 处理邮件发送失败的错误
				context.JSON(500, gin.H{
					"code":    500,
