...
func SelectEnterpriseByPage(e *gin.Engine, db *gorm.DB) {
	e.POST("/v1/backend/enterprise/list", func(context *gin.Context) {
		...
		posts, count, err3 := fybDatabase.SelectAllEnterpriseByPage(db, query, pageNum, pageSize)
