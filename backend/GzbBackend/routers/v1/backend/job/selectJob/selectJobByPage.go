...
func SelectJobByPage(e *gin.Engine, db *gorm.DB) {
	e.POST("/v1/backend/job/list", func(context *gin.Context) {
		...
		posts, count, err3 := fybDatabase.SelectAllJobByPage(db, query, pageNum, pageSize)
