...
func SelectJobByID(e *gin.Engine, db *gorm.DB) {
	e.GET("/v1/backend/job/searchById", func(context *gin.Context) {
		...
		post, _, err1 := fybDatabase.SelectSingleJobByCondition(db, mp)
